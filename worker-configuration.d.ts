/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 28de91f5b4c926bfcfb8c1a661ca5537)
// Runtime types generated with workerd@1.20260903.1 2026-09-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	FAL_KEY: string;
	MOCK_FAL: string;
	MOCK_FAIL_RATE: string;
	CREDIT_MARKUP: string;
	PRICE_OUTPUT_480P: string;
	PRICE_OUTPUT_768P: string;
	FAL_PROMPT_EXPANSION: string;
	STORAGE_DIR: string;
	DATABASE_PATH: string;
	UNLIMITED_CREDITS: string;
	RUNNER_CONCURRENCY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FAL_KEY" | "MOCK_FAL" | "MOCK_FAIL_RATE" | "CREDIT_MARKUP" | "PRICE_OUTPUT_480P" | "PRICE_OUTPUT_768P" | "FAL_PROMPT_EXPANSION" | "STORAGE_DIR" | "DATABASE_PATH" | "UNLIMITED_CREDITS" | "RUNNER_CONCURRENCY" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ACCOUNT_ID">> {}
}
